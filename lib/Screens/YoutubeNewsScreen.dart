...
class YoutubeNewsScreen extends StatefulWidget {
  @override
  _YoutubeNewsScreenState createState() => _YoutubeNewsScreenState();
}

class _YoutubeNewsScreenState extends State<YoutubeNewsScreen> {
  Channel _channel;
  ...
  _initChannel() async {
    Channel channel = await APIService.instance
        .fetchChannel(channelId: 'UCnDfmcUyhgJp6xC1LmBLfUg');
    setState(() {
      _channel = channel;
    });
  }
